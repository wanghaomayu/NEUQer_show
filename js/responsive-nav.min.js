  ...
  var d = function (d, e) {
    ...
    var g, h, i, j, k, l, m = function (a, b, c, d) {
        if ('addEventListener' in a)try {a.addEventListener(b, c, d)} catch (e) {
          ...
          a.addEventListener(b, function (a) {c.handleEvent.call(c, a)}, d)
        ...
        if ('removeEventListener' in a)try {a.removeEventListener(b, c, d)} catch (e) {
          if ('object' != typeof c || !c.handleEvent)throw e
          a.removeEventListener(b, function (a) {c.handleEvent.call(c, a)}, d)
        } else'detachEvent' in a && ('object' == typeof c && c.handleEvent ? a.detachEvent('on' + b, function () {c.handleEvent.call(c)}) : a.detachEvent('on' + b, c))
      }, o = function (a) {
        ...
        return b
      }, p = function (a, b) {for (var c in b)a.setAttribute(c, b[c])},
      q = function (a, b) {0 !== a.className.indexOf(b) && (a.className += ' ' + b, a.className = a.className.replace(/(^\s*)|(\s*$)/g, ''))},
      r = function (a, b) {
        var c = new RegExp('(\\s|^)' + b + '(\\s|$)')
        a.className = a.className.replace(c, ' ').replace(/(^\s*)|(\s*$)/g, '')
      }, s = function (a, b, c) {for (var d = 0; d < a.length; d++)b.call(c, d, a[d])}, t = a.createElement('style'),
      u = a.documentElement, v = function (b, c) {
        var d
        this.options = {
          animate: !0,
          transition: 284,
    ...
    return v.prototype = {
      ...
      toggle: function () {j === !0 && (l ? this.close() : this.open())},
      open: function () {l || (r(g, 'closed'), q(g, 'opened'), q(u, h.navActiveClass), q(i, 'active'), g.style.position = h.openPos, p(g, {'aria-hidden': 'false'}), l = !0, h.open())},
      close: function () {l && (q(g, 'closed'), r(g, 'opened'), r(u, h.navActiveClass), r(i, 'active'), p(g, {'aria-hidden': 'true'}), h.animate ? (j = !1, setTimeout(function () {g.style.position = 'absolute', j = !0}, h.transition + 10)) : g.style.position = 'absolute', l = !1, h.close())},
      ...
      _init: function () {
        ...
        var d = this
        setTimeout(function () {d.resize()}, 20), m(b, 'resize', this, !1), m(b, 'focus', this, !1), m(a.body, 'touchmove', this, !1), m(i, 'touchstart', this, !1), m(i, 'touchend', this, !1), m(i, 'mouseup', this, !1), m(i, 'keyup', this, !1), m(i, 'click', this, !1), h.init()
      },
      _createStyles: function () {t.parentNode || (t.type = 'text/css', a.getElementsByTagName('head')[0].appendChild(t))},
      _removeStyles: function () {t.parentNode && t.parentNode.removeChild(t)},
      ...
      _closeOnNavClick: function () {
        if (h.closeOnNavClick) {
          ...
          s(a, function (c) {m(a[c], 'click', function () {k && b.toggle()}, !1)})
        }
      },
      _preventDefault: function (a) {return a.preventDefault ? (a.stopImmediatePropagation && a.stopImmediatePropagation(), a.preventDefault(), a.stopPropagation(), !1) : void(a.returnValue = !1)},
      _onTouchStart: function (a) {Event.prototype.stopImmediatePropagation || this._preventDefault(a), this.startX = a.touches[0].clientX, this.startY = a.touches[0].clientY, this.touchHasMoved = !1, n(i, 'mouseup', this, !1)},
      _onTouchMove: function (a) {(Math.abs(a.touches[0].clientX - this.startX) > 10 || Math.abs(a.touches[0].clientY - this.startY) > 10) && (this.touchHasMoved = !0)},
